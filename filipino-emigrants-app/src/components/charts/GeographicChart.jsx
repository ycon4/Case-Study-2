// src/components/charts/GeographicChart.js

import React, { useState, useEffect } from 'react';
import PhilippinesChoropleth from './PhilippinesChoropleth';
import WorldChoroplethMap from './WorldChoroplethMap';

// Define the order and mapping of the charts
const CHART_ORDER = [
    { id: 'placeOfOrigin', label: 'Philippines Regional Origin', component: PhilippinesChoropleth },
    { id: 'majorCountries', label: 'Major Country Destinations', component: WorldChoroplethMap },
];
...
function GeographicChart({ activeDataset }) {
    ...
    return (
        <div>
            <h2 className="content-title">Geographic Analysis</h2>
